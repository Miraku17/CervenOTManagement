...
"[project]/node_modules/@google/genai/dist/web/index.mjs [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ function resourceName(client, resourceName1, resourcePrefix, splitsAfterPrefix = 1) {
    ...
    if (client.isVertexAI()) {
        if (resourceName1.startsWith('projects/')) {
            return resourceName1;
        } else if (resourceName1.startsWith('locations/')) {
            return `projects/${client.getProject()}/${resourceName1}`;
        } else if (resourceName1.startsWith(`${resourcePrefix}/`)) {
            return `projects/${client.getProject()}/locations/${client.getLocation()}/${resourceName1}`;
        } else if (shouldAppendPrefix) {
            return `projects/${client.getProject()}/locations/${client.getLocation()}/${resourcePrefix}/${resourceName1}`;
        } else {
            return resourceName1;
        }
    }
    if (shouldAppendPrefix) {
        return `${resourcePrefix}/${resourceName1}`;
    }
    return resourceName1;
}
...
//# sourceMappingURL=node_modules_%40google_genai_dist_web_index_mjs_aa8368b0._.js.map