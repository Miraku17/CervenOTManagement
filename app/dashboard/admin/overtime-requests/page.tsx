...
export default function OvertimeRequestsPage() {
  ...
  const hasAccess = hasPermission('view_overtime');
  const canApproveLevel1 = hasPermission('approve_overtime_level1');
  const canApproveLevel2 = hasPermission('approve_overtime_level2');
      ...
      <div className="max-w-2xl mx-auto mt-12">
        <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-8 text-center">
          ...
          <p className="text-slate-300 mb-2">
            You don't have permission to view overtime requests.
          </p>
